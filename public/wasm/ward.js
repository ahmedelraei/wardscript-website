 ...
 * @param {string} entry
 * @param {string} target
 * @param {boolean} asyncio
 * @returns {string}
 */
export function build(files, entry, target, asyncio) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.build(ptr0, len0, ptr1, len1, ptr2, len2, asyncio);
        deferred4_0 = ret[0];
        deferred4_1 = ret[1];
 ...
 * @returns {string}
 */
export function check(files, entry) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(files, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function python_runtime() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.python_runtime();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function run_plan(files, entry, _function) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(files, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.run_plan(ptr0, len0, ptr1, len1, ptr2, len2);
        deferred4_0 = ret[0];
        deferred4_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ward_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
